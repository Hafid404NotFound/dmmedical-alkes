        ...
        <div className="relative">
          ...
          >
            ...
            {loading &&
              [1, 2, 3].map((idx) => (
                <SwiperSlide key={`skeleton-${idx}`}>
                  <div className="bg-white p-6 rounded-xl shadow-xl min-h-[250px] animate-pulse border-t-4 border-gray-300">
            ...
            {!loading && data.length === 0 && (
              <SwiperSlide>
                <div className="flex flex-col items-center justify-center min-h-[250px] text-gray-500 bg-white p-6 rounded-xl shadow-xl border-t-4 border-slate-300">
            ...
            {!loading &&
              data.map((item) => (
                <SwiperSlide key={item.id}>
                  <div className="bg-white rounded-xl shadow-xl overflow-hidden min-h-[250px] h-full flex flex-col border-t-4 border-primary-main group hover:shadow-2xl transition-shadow duration-300">
                    <div className="p-6 flex-grow flex flex-col">
                      <div className="flex items-start mb-4">
                        <MdCheckCircle className="w-10 h-10 text-primary-main mr-3 shrink-0 group-hover:scale-110 transition-transform duration-300" />
                        <div className="flex-1">
                      ...
                      <p className="text-gray-700 text-sm sm:text-base leading-relaxed line-clamp-5 flex-grow">
                        {item.message}
                      </p>
                    </div>
                  </div>
